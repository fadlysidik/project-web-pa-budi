    ...
    <div class="card-body">
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          ...
          <input type="number" step="0.01" id="kewajiban_total" name="kewajiban_total" class="form-control">
        </div>
        <div class="form-group col-md-6">
          <label for="kewajiban_semester">Kewajiban Semester</label>
          <input type="number" step="0.01" id="kewajiban_semester" name="kewajiban_semester" class="form-control">
        </div>
      </div>
      <div class="form-group">
